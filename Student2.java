...
public class Student2 extends Subject {
    String name;
    int matricula;
    double score1;
    double score2;
    ...
    public Student2(String name, int matricula, double finalScore,String subject1,String subject2,String subject3,String subject4,String subject5){
